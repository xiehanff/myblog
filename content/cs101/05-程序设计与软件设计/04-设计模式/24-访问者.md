...
classDiagram
  ...
  ObjectStructure o-- "0..*" Element : stores
  ObjectStructure ..> Visitor : traverses with
  Element ..> Visitor : accepts
  Visitor ..> Element : dispatches on concrete element
  Client --> ObjectStructure : starts traversal
```
