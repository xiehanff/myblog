...
classDiagram
  ...
  class CoffeePot
  class Calendar
  Mediator <|.. WakeUpRoutine
  Colleague <|-- Alarm
  Colleague <|-- CoffeePot
  Colleague <|-- Calendar
  WakeUpRoutine o-- Alarm : coordinates
  WakeUpRoutine o-- CoffeePot : coordinates
  WakeUpRoutine o-- Calendar : coordinates
  Colleague --> Mediator : reports changes through
```
