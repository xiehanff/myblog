...
<figure class="diagram-scroll"><img src="./20-观察者.assets/pattern-relationship.svg" alt="关系图：观察者：Subject 通知已订阅对象"></figure>
...
- Dart 标准库没有与 GoF Subject/Observer 同名的一对多实现，本篇示例就是最小实现。
