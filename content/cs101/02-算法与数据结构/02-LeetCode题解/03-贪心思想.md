...
<div align="center"> <img src="../../../assets/images/upstream-cs-notes/e69537d2-a016-4676-b169-9ea17eeb9037.gif" width="430px"> </div><br>
...
双指针只让 `s` 和 `t` 各向前走一次，时间复杂度为 O(|s| + |t|)，额外空间为 O(1)。逐字符调用 `String.indexOf` 虽然结果正确，但最坏会重复扫描 `t`，不能把它写成线性复杂度。
