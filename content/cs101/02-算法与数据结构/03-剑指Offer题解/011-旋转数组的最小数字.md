...
<div align="center"> <img src="../../../assets/images/upstream-cs-notes/0038204c-4b8a-42a5-921d-080f6674f989.png" width="210px"> </div><br>

## 解题思路

将旋转数组对半分可以得到一个包含最小元素的新旋转数组，以及一个非递减排序的数组。新的旋转数组的长度是原数组的一半，从而将问题规模减少了一半，这种折半性质的算法的时间复杂度为 O(log<sub>2</sub>N)。

<div align="center"> <img src="../../../assets/images/upstream-cs-notes/424f34ab-a9fd-49a6-9969-d76b42251365.png" width="300px"> </div><br>
