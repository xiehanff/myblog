...
<div align="center"> <img src="../../../assets/images/upstream-cs-notes/image-20201105012506187.png" width="400px"> </div><br>
...
public double Power(double x, int n) {
    if (x == 0 && n < 0)
        return 0; // 题目通常不包含该输入；避免出现除以 0 的异常语义
