...
2023 年 8 月，工信部发布《工业和信息化部关于开展移动互联网应用程序备案工作的通知》，App 备案制度的时间线（这是本文的立论基础，务必记准）：

- **2023 年 9 月 1 日起**：新 App **先备案、后上架**——备案成为上架的前置条件
...
标题里"许可"两个字，指的是**增值电信业务经营许可**——它和备案是两回事：备案是"向监管登记你存在"，许可是"监管允许你经营某类业务"。判断标准一句话：**你的 App 是不是"通过互联网向用户收费提供服务"**。
...
1. **卖会员/虚拟商品**——只要用户直接付钱换取 App 内的服务或内容，就是经营性行为，光有备案不够；
2. **撮合交易**——自己是平台、买卖双方是用户，需要评估 EDI；自营卖货则走营业执照 + 商品资质路线，不是 EDI；
3. **广告收入**——很多团队以为"不向用户收费就不用办"，广告变现同样具有经营属性，是否需要办证建议咨询属地通信管理局，口径存在地区差异。

#### 7.2 办证与备案的关系

- **主体一致**：许可证持证主体、ICP 备案主体、App Store 开发者主体、软著著作权人，四者建议保持同一企业主体——不一致是备案被驳回和商店审核被拒的经典原因；
- **先备案后许可**：经营性网站/App 通常先完成 ICP 备案，再申请经营许可证（各省流程细节以属地管局要求为准）；
- **周期与成本**：ICP 许可证办理周期通常以月计，涉及社保证明、注册资金等要求——**产品排期里必须预留这段窗口**，很多团队的教训是上架前一周才发现要办证。

#### 7.3 架构师视角的合规清单

上线前过一遍这张清单（按"缺了就不能上线"排序）：
